...
class reportClass:
    def __init__(self, root):
        ...
        # Title
        title = Label(self.root, text="View Student Result", font=("goudy old style", 15, "bold"), bg="orange", fg="#262626")
    ...
    def search(self):
        ...
        try:
            if self.var_search.get()=="":
                messagebox.showerror("error","Roll no. sholud be required",parent=self.root)
            else:                         
            ...
            if self.var_id == "":
                ...
                if row is None:
                    ...
                    if op==True:
                        ...
                        con.commit()
                        messagebox.showinfo("Delete","Result deletd Successfully",parent=self.root)
                        self.clear()
        except Exception as ex:
            messagebox.showerror("Error", f"Error due to {str(ex)}")
